...
import { IconChat, IconHeart, IconHeartFilled, IconShare } from './FluentIcons'
...
export default function CatalogCardActions({ brochure, catalogId }) {
  ...
  return (
    <div className="catalog-card__actions" role="group" aria-label={t('catalogs.actionsLabel')}>
      ...
      >
        {isLiked ? (
          <IconHeartFilled className="catalog-card__action-icon" size={20} aria-hidden />
        ) : (
          <IconHeart className="catalog-card__action-icon" size={20} aria-hidden />
        )}
      </button>
      ...
      >
        <IconChat className="catalog-card__action-icon" size={20} aria-hidden />
      </a>
      ...
      <div className="catalog-card__share-wrap">
        ...
        >
          <IconShare className="catalog-card__action-icon" size={20} aria-hidden />
        </button>
        {shareOpen && (
          <>
